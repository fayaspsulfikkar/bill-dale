      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          <motion.div
            ...
            className="w-20 h-20 bg-primary rounded-3xl flex items-center justify-center shadow-[0_0_60px_rgba(var(--primary),0.4)] mb-5"
          >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 h-13 py-3.5 bg-white text-gray-800 font-semibold rounded-xl border border-gray-200 shadow-md hover:shadow-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? (
